...
SELECT *
 ...
 WHERE A.MATDLT IS NULL
   AND EXISTS
 (SELECT 1 FROM DIM_GOOD B WHERE A.ITEM_CODE = B.ITEM_CODE);

--228808 曲朗多西藏那曲冬虫夏草7克礼盒装（30支装）
SELECT * FROM OPER_PRODUCT_DAILY_PREVIEW;
SELECT * FROM DIM_EC_GOOD A WHERE A.ITEM_CODE=910070;
SELECT * FROM DIM_GOOD A WHERE A.ITEM_CODE=910070;
