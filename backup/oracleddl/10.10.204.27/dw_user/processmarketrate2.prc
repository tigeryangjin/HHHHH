???create or replace procedure dw_user.processmarketrate2 is
  ...
  */
begin
  sp_name          := 'processmarketrate2'; --需要手工填入所写PROCEDURE的名称
    ...
    for i in 1 .. var_array.count loop
      ...
      insert into fact_lcrate_market
        (create_date_key,
         ...
         hitcnt,
         viewcnt)
        select var_array(i).zthrc011 as create_date_key,
                  ...
                  from (select a.application_key, a.hmsc, a.vid
                        ...
                        select b.application_key, b.hmsc, b.vid
                         ...
                         where b.application_key in (10, 20)
                           and b.start_date_key = var_array(i).zthrc011) x1
