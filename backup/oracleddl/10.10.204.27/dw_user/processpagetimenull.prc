???create or replace procedure dw_user.processpagetimenull is
  ...
  */
begin
  sp_name          := 'processpagetimenull'; --需要手工填入所写PROCEDURE的名称
  ...
  begin
    ...
    select * bulk collect
     ...
     where e.id between startpoint and startpoint + 20000
