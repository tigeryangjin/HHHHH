???CREATE OR REPLACE PACKAGE DW_USER.HAPPIGO_EC_PKG IS
...
CREATE OR REPLACE PACKAGE BODY DW_USER.HAPPIGO_EC_PKG IS
  ...
  BEGIN
    ...
    BEGIN
      ...
      USING (SELECT B.GOODS_ID,
                    ...
                    B.BRAND_ID,
                    B.GOODS_PRICE,
                    B.GOODS_PROMOTION_PRICE,
                    B.GOODS_PROMOTION_TYPE,
                    B.GOODS_PROMOTION_ID,
                    B.GOODS_PROMOTION_PRICE_APP,
                    B.GOODS_PROMOTION_TYPE_APP,
                    B.GOODS_PROMOTION_ID_APP,
                    B.GOODS_PROMOTION_PRICE_WX,
                    B.GOODS_PROMOTION_TYPE_WX,
                    B.GOODS_PROMOTION_ID_WX,
                    B.GOODS_PROMOTION_PRICE_3G,
                    B.GOODS_PROMOTION_TYPE_3G,
                    B.GOODS_PROMOTION_ID_3G,
                    B.GOODS_MARKETPRICE,
                    B.GOODS_SERIAL,
                    B.GOODS_STORAGE_ALARM,
                    B.GOODS_CLICK,
                    B.GOODS_SALENUM,
                    B.GOODS_COLLECT,
                    B.GOODS_SPEC,
                    ...
                    B.GOODS_COMMEND,
                    B.GOODS_STCIDS,
                    B.EVALUATION_GOOD_STAR,
                    B.EVALUATION_COUNT,
                    B.IS_VIRTUAL,
                    B.VIRTUAL_INDATE,
                    B.VIRTUAL_LIMIT,
                    B.VIRTUAL_INVALID_REFUND,
                    B.IS_FCODE,
                    B.IS_APPOINT,
                    B.IS_PRESELL,
                    B.HAVE_GIFT,
                    ...
                    B.IS_ALLOW_POINT,
                    B.IS_ALLOW_VOUCHER,
                    B.IS_ALLOW_PAYPROMOTION,
                    B.PAYPROMOTION_AMOUNT,
                    B.IS_ALLOW_BANKPROMOTION,
                    B.IS_VALUABLES,
                    B.IS_BIG,
                    B.GIVE_POINTS,
                    B.SYNC_RULE_ID,
               ...
               FROM (SELECT A.GOODS_ID,
                            ...
                            A.RATEBY,
                            A.DELAY_DAYS,
                            ROW_NUMBER() OVER(PARTITION BY A.GOODS_ID ORDER BY A.GOODS_EDITTIME) RN
                       FROM EC_GOODS_TMP A) B
              WHERE B.RN = 1) S
