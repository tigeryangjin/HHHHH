???create or replace procedure dw_user.processdimmemberodinc(startpoint number) is
...
begin
  ...
  sp_name          := 'processdimmemberodinc'; --需要手工填入所写PROCEDURE的名称
  ...
  begin
   ...
   --    and e.order_state = 1; -- between '20160101' and '20160904'; order_date_key
    ...
    for i in 1 .. var_array.count loop
      ...
      select /*+ index(t1 MEMBER_ORDER_KEY) */ nvl(sum(case
             ...
             nvl(count(case
                 ...
                 0),
             nvl(count(case
                         when t1.cancel_before_state = 1 then
                          t1.order_key
                       end),
                 0),
             nvl(max(case
             ...
             nvl(count(case
                         when t1.sales_source_key = 20 and
                              ...
                              (20003，20013，20016，20018，20019，20023) and
