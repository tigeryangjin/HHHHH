???create or replace procedure dw_user.process3gpromotion2 is
  ...
  */
begin
  sp_name          := 'process3gpromotion2'; --需要手工填入所写PROCEDURE的名称
  s_etl.table_name := 'fact_daily_3gpromotion_2'; --此处需要手工录入该PROCEDURE操作的表格
  ...
  begin
    ...
    for i in 1 .. var_array.count loop
      ...
      */
      ...
      insert into fact_daily_3gpromotion_2
        (active_date_key,
         vid,
         member_key,
         member_date,
      ...
      update fact_daily_3gpromotion_2
         set member_date =to_number(to_char((to_date(var_array(i).date_key,'yyyymmdd')-7),'yyyymmdd'))
