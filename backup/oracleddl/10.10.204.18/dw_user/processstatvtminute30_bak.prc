???create or replace procedure dw_user.processstatvtminute30_bak(startpoint in varchar2) is
    ...
    loop
      ...
      insert into stats_online_visitor_minute
        ...
        select w_statid_s.nextval,
               ...
               z2.uvcount,
               30
          from (select 30, nvl(count(distinct p3.vid), 0) as uvcount
                
                  from fact_page_view_vt p3
                 where p3.visit_date >= i
                   and p3.visit_date < i + 30 / 24 / 60
