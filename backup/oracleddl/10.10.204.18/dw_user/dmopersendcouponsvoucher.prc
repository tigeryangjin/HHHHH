???create or replace procedure dw_user.dmopersendcouponsvoucher(postday in number) is
...
begin
  ...
  sp_name          := 'dmopersendcouponsvoucher'; --需要手工填入所写PROCEDURE的名称
  s_etl.table_name := 'oper_sendcoupons_voucher'; --此处需要手工录入该PROCEDURE操作的表格
