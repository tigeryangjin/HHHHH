???create or replace procedure dw_user.processstatvtminute5_bak(startpoint in varchar2) is
...
begin
  ...
  begin
    ...
    loop
      ...
      exit when to_number(to_char(i+5/24/60, 'yyyymmddhh24mi')) >= to_number(startpoint);
