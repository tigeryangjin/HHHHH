???create or replace procedure dw_happigo.processptime is
...
-- 153659425 and  154616681 154459428 154699781
  ...
  begin
    ...
    select * bulk collect
     ...
     where e.id between 264650468 and 264950468 --startpoint and  startpoint+300000
    ...
    update  fact_page_view z
     ...
     where z.id between 264650468 and 264950468;-- startpoint and  startpoint+300000
