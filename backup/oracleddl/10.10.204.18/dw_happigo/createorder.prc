???create or replace procedure dw_happigo.createorder is
...
begin
  ...
  insert into fact_orders
    ...
    select a.rec_id as id,
     ...
     where b.member_key = to_number(a.cust_no)
       and a.order_id = d.order_id
       and a.create_time between b.start_time and
           b.end_time
       and to_char(a.create_time, 'yyyy-mm-dd') >= '2015-09-08'
       and to_char(a.create_time, 'yyyy-mm-dd') < '2015-09-18'
       ;
