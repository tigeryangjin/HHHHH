???create or replace force view dw_happigo.order_good as
...
b2.order_id,b2.order_sn,b2.vid,b2.cust_no,b2.addtime,b2.add_time, a3.goods_pay_price,a3.goods_num,
...
where b2.app_name in ('KLGiPhone','KLGAndroid')
and   a3.order_id=b2.order_id
