???create or replace procedure dw_happigo.processpvsession  (startpoint in fact_page_view.id%type,
...
begin
  ...
  --269548706  insert into TMP_LI3 values(1,'1');/*+ index(a SESSION_KEY_IDX) */ /*+ index(b VIDETIME_IDX) */269060200
    ...
    for i in 1 .. var_array.count loop
      ...
      select /*+ index(b VIDETIME_IDX) */count(b.session_key)
        into count_key
        from fact_session b
