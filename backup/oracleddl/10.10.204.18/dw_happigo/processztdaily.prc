???create or replace procedure dw_happigo.processztdaily(startpoint in number) is
      ...
      from (select x1.zttypenm,
           ...
           (select x0.page_value,
                   ...
                   (select o2.goods_price
                     ...
                     (select
                     case when o2.is_kjg=1 then '(跨境购)'||o2.matdlt else
                      o2.matdlt end
                      from dim_ec_good o2
                     ...
                     where o2.goods_commonid = x1.goods_code) as Brand_Name,
                      (select decode(o2.is_tv,0,'电商提报组',1,'非电商提报组') 
                      from dim_ec_good o2
              ...
              from (select z0.page_name,
                           ...
                           count(distinct visitor_key) as ztvt
