BEGIN
	CREATEFACTORDERGOODSREVERSE(20180526);
	PROCESSUPDATEORDERREVERSE(20180526);
END;  
/
...
SELECT *
  FROM odshappigo.ods_order_cancel A
 WHERE A.ZTCRMC04 = 5208514566
 ORDER BY A.CRM_OBJ_ID;
...
SELECT * FROM FACT_ORDER_REVERSE A WHERE A.Order_Key = 5208514566;
