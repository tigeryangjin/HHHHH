...
--2.1.25line
/*
1 HAPPIGO_EC_PKG.MERGE_EC_VOUCHER_BATCH
2 HAPPIGO_EC_PKG.MERGE_EC_VOUCHER_PRICE
3 HAPPIGO_EC_PKG.MERGE_EC_P_MANSONG
4 HAPPIGO_EC_PKG.MERGE_EC_P_MANSONG_GOODS
5 HAPPIGO_EC_PKG.MERGE_EC_P_XIANSHI
6 HAPPIGO_EC_PKG.MERGE_EC_P_XIANSHI_GOODS
7 HAPPIGO_EC_PKG.MERGE_EC_ORDER
8 HAPPIGO_EC_PKG.MERGE_EC_ORDER_GOODS
8 HAPPIGO_EC_PKG.MERGE_EC_ORDER_COMMON
10  HAPPIGO_EC_PKG.MERGE_EC_VOUCHER
1 MEMBER_LABEL_PKG.FIRST_ORDER_NOT
2 MEMBER_LABEL_PKG.FIRST_ORDER_GIFT
3 MEMBER_LABEL_PKG.FIRST_ORDER_ITEM
4 MEMBER_LABEL_PKG.MEMBER_LEVEL
5 MEMBER_LABEL_PKG.MEMBER_REPURCHASE
1 MEMBER_SMS_PKG.MEMBER_SMS_POOL_OMMD
2 MEMBER_SMS_PKG.OPER_MEMBER_MBLEVEL_DCGOOD
1 YANGJIN_PKG.PROCESSMAKETHMSC_IA
2 YANGJIN_PKG.OPER_NM_PROMOTION_ITEM_RPT
3 YANGJIN_PKG.OPER_NM_PROMOTION_ORDER_RPT
4 YANGJIN_PKG.OPER_NM_VOUCHER_RPT
5 YANGJIN_PKG.OPER_PRODUCT_PVUV_DAILY_RPT
6 YANGJIN_PKG.OPER_MEMBER_NOT_IN_EC
7 YANGJIN_PKG.OPER_PRODUCT_DAILY_RPT
8 YANGJIN_PKG.DIM_GOOD_PRICE_LEVEL_UPDATE
*/
SELECT T.START_TIME,
       T.END_TIME,
       T.ETL_DURATION,
       SUBSTR(T.PROC_NAME, 1, INSTR(T.PROC_NAME, '.') - 1) || '_' || RANK() OVER(PARTITION BY SUBSTR(T.PROC_NAME, 1, INSTR(T.PROC_NAME, '.') - 1) ORDER BY T.TABLE_NAME, T.END_TIME DESC) RANK1,
       T.PROC_NAME,
       T.TABLE_NAME,
       T.ETL_STATUS,
       T.ETL_DURATION,
...
--2.2.8line
/*
1 OPER_MEMBER_LIKE_PKG.OPER_MEMBER_LIKE_BASE_PROC
2 OPER_MEMBER_LIKE_PKG.OPER_MEMBER_LIKE_ITEM_PROC
3 OPER_MEMBER_LIKE_PKG.OPER_MEMBER_LIKE_MATXL_PROC
1 OPER_MEMBER_MARKETING_PKG.PROC_MBR_THIRD_ORDER_30DAYS
2 OPER_MEMBER_MARKETING_PKG.PROC_MBR_SECOND_ORDER_20DAYS
3 OPER_MEMBER_MARKETING_PKG.PROC_MBR_FIRST_ORDER_15DAYS
4 OPER_MEMBER_MARKETING_PKG.PROC_MBR_REG_WITHOUT_ORDER
5 OPER_MEMBER_MARKETING_PKG.PROC_MBR_ORDER_PUSH
*/
SELECT T.START_TIME,
       T.END_TIME,
       T.ETL_DURATION,
...
SELECT DISTINCT A.GOODS_KEY
 ...
 ORDER BY 1;
--2.4.1.每个商品的最大ROW_WID的current_flg='Y'
SELECT *
  FROM DIM_GOOD A
