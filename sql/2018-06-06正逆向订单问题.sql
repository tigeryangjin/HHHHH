/*
5207785667正，5208700934逆
问题点:ODSHAPPIGO.ODS_ORDER只有逆向订单
*/
--1.
select *
  from SAP_BIC_AZTCRD00100 a
 where a."/BIC/ZTCRMC04" IN (5207785667, 5208700934);
 
select * from SAP_BIC_AZTCRD00100 a where A.CRM_OHGUID = 20180413742427;

--2.
SELECT * FROM ODSHAPPIGO.OD_ORDER A WHERE A.ORDER_NO = 20180413742427;
SELECT * FROM ODSHAPPIGO.OD_ORDER_ITEM A WHERE A.ORDER_NO = 20180413742427;
--3.
SELECT *
  FROM ODSHAPPIGO.OD_ORDER_ITEM A
 WHERE A.ECC_ORDER_NO IN (5207785667, 5208700934);

--4.
SELECT * FROM ODSHAPPIGO.ODS_ORDER A WHERE A.CRM_OHGUID = 20180413742427;

SELECT * FROM ODSHAPPIGO.ODS_ORDER A WHERE A.CRMPOSTDAT=20180605 AND A.CRM_ITMTYP LIKE 'REN%';

--5.
-- FACT_GOODS_SALES
CALL CREATEORDERGOODS(20170928);
-- FACT_GOODS_SALES
CALL PROCESSUPDATEORDER(20170928);
-- FACT_GOODS_SALES_REVERSE 
CALL CREATEFACTORDERGOODSREVERSE(20180605);
-- FACT_GOODS_SALES_REVERSE
CALL PROCESSUPDATEORDERREVERSE(20180605);
--
CALL YANGJIN_PKG.OPER_PRODUCT_DAILY_RPT(20180605);

--5.1
call od_order_etl.insert_ods_order(20180407);
call od_order_etl.insert_ods_order(20180605);
CALL CREATEORDERGOODS(20180407);
CALL PROCESSUPDATEORDER(20180407);
CALL CREATEFACTORDERGOODSREVERSE(20180605);
CALL PROCESSUPDATEORDERREVERSE(20180605);
CALL YANGJIN_PKG.OPER_PRODUCT_DAILY_RPT(20180605);
