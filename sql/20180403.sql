...
SELECT A.Item_Code,
 ...
 WHERE A.POSTING_DATE_KEY = 20180326
...
SELECT A.ORDER_KEY,
 ...
 WHERE A.SALES_SOURCE_SECOND_KEY = '20017'
   AND A.POSTING_DATE_KEY = 20180326
   AND A.GOODS_COMMON_KEY = 230669;
--4.
SELECT *
 ...
 WHERE A.SALES_SOURCE_SECOND_KEY = '20017'
   ...
   AND A.GOODS_COMMON_KEY = 230669;
--5.
SELECT * FROM ODSHAPPIGO.ODS_ORDER A WHERE A.ZTCRMC04 = 5207126315;
--6.
SELECT * FROM ODSHAPPIGO.OD_ORDER A WHERE A.CRM_ORDER_NO = 5207126315;
