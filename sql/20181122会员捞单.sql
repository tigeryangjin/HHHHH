...
SELECT * FROM DIM_GOOD_CLASS A WHERE A.MATDLT LIKE '%美妆%';
SELECT * FROM DIM_GOOD_CLASS A WHERE A.MATZLT LIKE '%美妆%';
SELECT * FROM DIM_GOOD_CLASS A WHERE A.MATXLT LIKE '%美妆%';
SELECT * FROM DIM_GOOD_CLASS A WHERE A.Matklt LIKE '%美妆%';
