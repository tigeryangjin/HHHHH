...
SELECT A.SALES_SOURCE_SECOND_NAME,
 ...
 WHERE A.POSTING_DATE_KEY = 20180620
...
--3.
  SELECT *
   ...
   WHERE A.POSTING_DATE_KEY = 20180620
     AND A.SALES_SOURCE_SECOND_NAME = '新媒体APP（2.0）'
     AND A.ITEM_CODE = 240825;

--4.
SELECT *
  FROM FACT_GOODS_SALES A
 WHERE (A.POSTING_DATE_KEY = 20180620 OR A.UPDATE_TIME = 20180620)
   AND A.GOODS_COMMON_KEY = 240825
...
SELECT *
 ...
 WHERE A.CRMPOSTDAT = 20180620
   AND A.ZMATER2 = '000000000000240825'
...
SELECT *
 ...
 WHERE A.CRMPOSTDAT = 20180620
   AND A."/BIC/ZMATER2" = '000000000000240825';

--8.
SELECT *
  FROM ODSHAPPIGO.OD_ORDER_ITEM A
 WHERE TRUNC(A.ORDER_DATE) = DATE '2018-06-20'
   AND A.ITEM_CODE = 240825;
