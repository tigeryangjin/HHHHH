...
SELECT * FROM FACT_PAGE_VIEW A WHERE A.VISIT_DATE_KEY = 20181219;
SELECT *
  FROM FACT_PAGE_VIEW A
 WHERE A.VISIT_DATE_KEY = REPLACE('2018-12-19', '-');

ALTER TABLE DW_USER.DIM_PAGE MOVE PARALLEL(DEGREE 4);
