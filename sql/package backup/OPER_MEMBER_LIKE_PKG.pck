    ...
    INSERT INTO OPER_MEMBER_LIKE_BASE
      ...
      SELECT OPER_MEMBER_LIKE_BASE_SEQ.NEXTVAL,
        ...
        FROM (SELECT F.POSTING_DATE_KEY,
                     ...
                     SYSDATE W_INSERT_DT,
                     SYSDATE W_UPDATE_DT
                FROM ( /*浏览*/ WITH PV AS (SELECT P.VISIT_DATE_KEY POSTING_DATE_KEY,
                                                 P.MEMBER_KEY,
                                                 G.ITEM_CODE,
                                                 P.PV_FREQ
                                           ...
                                           WHERE P.PAGE_VALUE =
                                                 G.GOODS_COMMONID(+)
                                             AND G.CURRENT_FLG = 'Y'),
                     /*收藏*/ FAV AS (SELECT F.FAV_TIME POSTING_DATE_KEY,
                                           G.ITEM_CODE,
                                     ...
                                     GROUP BY F.FAV_TIME,
                                              G.ITEM_CODE,
                                              M.MEMBER_CRMBP),
                     /*加购物车*/ CAR AS (SELECT A.CREATE_DATE_KEY POSTING_DATE_KEY,
                                             B.ITEM_CODE,
                                             A.MEMBER_KEY,
                                             A.CAR_FREQ
                                       ...
                                       WHERE A.GOODS_COMMON_KEY =
                                             B.GOODS_COMMONID
                                         AND B.CURRENT_FLG = 'Y'),
                     /*订购*/ ORD AS (SELECT B.POSTING_DATE_KEY,
                                           B.MEMBER_KEY,
                                           B.ITEM_CODE,
